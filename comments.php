	...
	<div class="comments" id="comments">
		...
		<div class="comments-header">
			...
			if ( ! have_comments() ) {
				...
				printf( _x( 'One reply on &ldquo;%s&rdquo;', 'comments title', 'blogcards' ), get_the_title() );
			} else {
				printf(
		...
		<div class="commentlist">
			...
			$comment_pagination = paginate_comments_links(
				array(
					...
					'end_size'  => 0,
					'mid_size'  => 0,
					'next_text' => __( 'Newer Comments', 'blogcards' ) . ' <span aria-hidden="true">&rarr;</span>',
					'prev_text' => '<span aria-hidden="true">&larr;</span> ' . __( 'Older Comments', 'blogcards' ),
				)
			);
